module bedrock_asset::brbtc {
    ...
    fun init_module(object_deployer: &signer) {
        let constructor_ref = &object::create_named_object(object_deployer, ASSET_SYMBOL);
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            ...
            utf8(ASSET_SYMBOL),
            ASSET_DECIMALS,
            utf8(b"https://static.bedrock.technology/brBTC.png"),
    ...
    public entry fun transfer_admin(
        ...
        let store_mut = borrow_global_mut<AccessStorage>(@bedrock_asset);
